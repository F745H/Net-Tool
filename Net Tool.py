...
#Ping Label
pingUserLabel = Label(container, text='Ping:-', bg="#856ff8", font=("Helvetica", "10", "bold"))
...
#Check box
checkButton = Checkbutton(container, text = "4 packets", variable = checkBtVar, onvalue = TRUE, offvalue = FALSE, bg="#856ff8", activebackground="#856ff8")
...
#Traceroute Label
tracertUserLabel = Label(container, text='Traceroute:-', bg="#856ff8", font=("Helvetica", "10", "bold"))
...
#Restart Label
restartUserLabel = Label(container, text='Restart Network Devices:-', bg="#856ff8", font=("Helvetica", "10", "bold"))
...
#Resolve Label
resolveUserLabel = Label(container, text='Resolve Network Problems:-', bg="#856ff8", font=("Helvetica", "10", "bold"))
